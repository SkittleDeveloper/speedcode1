...
.setAuthor(`ShieldsBOT Yardım Menüsü`)
.setColor("RANDOM")
.setDescription(`
...
mesaj.delete().catch(err =>  console.log("Mesaj bulunamadığı için silemedim"))
    ...
    .setAuthor(`ShieldsBOT Kayıt Yardım Menüsü`)
    .setColor(`RANDOM`)
    .setDescription(`
    ${client.commands
        ...
        .map(nrc => ` **<a:isaret_sol:944941945313177620> ${ayarlar.prefix}${nrc.name}** = ${nrc.description || "**Açıklama Eklenmemiş**"}`)
    ...
    .setAuthor(`ShieldsBOT Moderasyon Yardım Menüsü`)
    .setColor(`RANDOM`)
    .setDescription(`
    ${client.commands
    ...
    const kayıt = new Discord.MessageEmbed()
    .setAuthor(`ShieldsBOT Bot Yardım Menüsü`)
    .setColor(`RANDOM`)
    .setDescription(`
    ${client.commands
    ...
    const kayıt = new Discord.MessageEmbed()
    .setAuthor(`ShieldsBOT Ekonomi Yardım Menüsü`)
    .setColor(`RANDOM`)
    .setDescription(`
    ${client.commands
